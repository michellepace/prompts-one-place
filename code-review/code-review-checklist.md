*Prompt in here. Make as template so you can re-use easily. Include notes if needed. I put it into a code block so its easy to copy paste, but you don't have to*
